...
//---- Disable IM_ASSERT_USER_ERROR (ImGui 1.92.8+ asserts on SetCursorPos extending boundaries).
// Our layout code uses SetCursorPos patterns that trigger this. The override suppresses the
// assertion popup while preserving early-return safety for ImGui's internal error recovery.
#ifndef IM_ASSERT_USER_ERROR
#define IM_ASSERT_USER_ERROR(_EXPR, _MSG)       ((void)(_EXPR), (void)(_MSG))
